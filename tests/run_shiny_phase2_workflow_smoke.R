...
wait_for_element("compare_environment-mantel_method")
wait_for_element("compare_environment-mantel_alternative")
wait_for_element("compare_environment-spec_dist_method")
wait_for_element("compare_environment-env_dist_method")
wait_for_element("compare_environment-mantel_permutations")
...
wait_for_element("compare_environment-report_presets")
...
set_input_nowait("compare_environment-env_dist_method", "euclidean")
