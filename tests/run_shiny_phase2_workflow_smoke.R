...
click_tab("Network Compare")
set_input("network_compare-compare_graph_ids", c("obj_0009", "obj_0010"))
wait_for_element("network_compare-comparison_pairs")
wait_for_element("network_compare-compare_links")
wait_for_element("network_compare-report_presets")
wait_for_element("network_compare-compare_topology")
click("#network_compare-run_compare")
wait_for_text("Registered comparison plot:", timeout = 120000)
wait_for_text("Topology Comparison", timeout = 120000)
set_input("network_compare-multi_group_id", "obj_0005")
click("#network_compare-run_multi_group")
wait_for_text("Registered grouped network plot:", timeout = 120000)

click_tab("Environment Links")
wait_for_element("environment_links-env_blocks")
wait_for_element("environment_links-spec_blocks")
wait_for_element("environment_links-env_spec_pairs")
wait_for_element("environment_links-mantel_method")
wait_for_element("environment_links-mantel_alternative")
wait_for_element("environment_links-spec_dist_method")
wait_for_element("environment_links-env_dist_method")
wait_for_element("environment_links-mantel_permutations")
wait_for_element("environment_links-env_orientation")
wait_for_element("environment_links-env_spec_layouts")
wait_for_element("environment_links-env_group_layout")
wait_for_element("environment_links-env_group_angle")
wait_for_element("environment_links-env_group_arc_angle")
wait_for_element("environment_links-env_ncol")
wait_for_element("environment_links-env_heatmap_label_size")
wait_for_element("environment_links-env_heatmap_sig_size")
wait_for_element("environment_links-env_heatmap_point_size")
wait_for_element("environment_links-env_sig_line_width_min")
wait_for_element("environment_links-env_sig_line_width_max")
wait_for_element("environment_links-env_sig_line_color_low")
wait_for_element("environment_links-env_sig_line_color_high")
wait_for_element("environment_links-env_sig_line_alpha")
wait_for_element("environment_links-module_graph_id")
set_input("environment_links-env_ncol", 2)
set_input("environment_links-env_heatmap_label_size", 4)
set_input("environment_links-env_heatmap_sig_size", 3)
set_input("environment_links-env_heatmap_point_size", 4.5)
set_input("environment_links-env_sig_line_width_min", 0.25)
set_input("environment_links-env_sig_line_width_max", 1.75)
set_input("environment_links-env_sig_line_color_low", "#2166ac")
set_input("environment_links-env_sig_line_color_high", "#b2182b")
set_input("environment_links-env_sig_line_alpha", 0.8)
set_input("environment_links-mantel_method", "spearman")
set_input("environment_links-mantel_alternative", "greater")
set_input("environment_links-spec_dist_method", "bray")
set_input_nowait("environment_links-env_dist_method", "euclidean")
set_input("environment_links-mantel_permutations", 9)
click("#environment_links-run_environment")
wait_for_text("Registered environment link plot:", timeout = 120000)
click("#environment_links-run_environment_manual")
wait_for_text("Registered manual environment heatmap:", timeout = 120000)
click("#environment_links-run_module_environment")
wait_for_text("Registered module environment heatmap:", timeout = 120000)
click("#environment_links-run_environment_triple")
...
wait_for_text("Restore conflicts", timeout = 120000)
wait_for_text("Replay steps", timeout = 120000)
wait_for_element("export_center-restore_plan", timeout = 120000)
wait_for_element("export_center-replay_plan", timeout = 120000)
