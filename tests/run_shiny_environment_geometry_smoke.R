...
set_input("environment_links-env_orientation", "top_right")
set_input("environment_links-env_spec_layouts", "circle_outline")
set_input("environment_links-env_group_layout", "row")
set_input("environment_links-env_nrow", 1)
