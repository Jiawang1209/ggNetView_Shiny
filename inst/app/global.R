...
invisible(lapply(c(
  ...
  "safe_graph_info", "graph_module_choices", "safe_module_subgraph", "safe_magnified_subgraph", "safe_sample_subgraph",
  ...
  "coerce_tbl_graph", "perturbation_node_names", "perturbation_module_values", "normalize_fraction_step",
  "safe_network_perturbation", "safe_perturbation_curve_plot", "safe_node_influence", "safe_press_perturbation",
  ...
  "safe_environment_link", "safe_environment_heatmap", "safe_link_heatmap_adaptive", "safe_module_environment_heatmap",
