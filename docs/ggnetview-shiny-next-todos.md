...
- `tests/run_shiny_upload_to_builder_smoke.R` guards the human upload path: uploading a file in Data Hub immediately registers it and makes it selectable in Graph Builder without an extra Register click.
