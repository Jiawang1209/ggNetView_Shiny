...
- Compare & Environment can register multi-network comparison plots, normalized link tables, topology comparison summaries, environment-link plots/statistics, and Mantel pairwise tables.
...
3. Environment and multi-omics depth.
   ...
   - Still needed: multi-core options, richer multi-omics presets, and finer manual control over environment/spec block selections.
...
4. Multi-network comparison depth.
   ...
   - Still needed: richer comparison-group controls and more detailed link interpretation tables.
